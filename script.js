...
const characters = [
  ...
  "Вооз", "Зоровавель", "Мириам", "Авимелех", "Иеффай", "Илий", "Иаков(брат Христа)", "Иуда(брат Христа)", "Мелхиседек", "Елисей"] //h
];
...
const events = [
  ...
  "Грех Давида", "Тайная вечеря", "10 заповедей"], //e
...
const geography = [
  ...
  "Гора Арарат", "Ниневия", "Египет", "Дамаск", "Месопотамия"], //e
  ["Иордан", "Колодец Иакова", "Город Давида", "Храмовая гора", 
  "Дамаск", "Храм Зоровавеля", 
  "Вифания", "Кана Галилейская", 
  "Иудейская пустыня", "Ефрат", "Вефиль"] , //n
